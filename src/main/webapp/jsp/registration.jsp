...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="row d-flex">
            <div class="col-md-4 ftco-animate img" style="background-image: url(${pageContext.request.contextPath}/images/bg_1.jpg);"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" placeholder="Confirm Password"  name="confirmedPassword">
                            </div>
                        </div>
